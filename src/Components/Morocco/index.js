            ...
            <div id="expand">
                ...
                {day1 &&
                    <div className="days" id="day1">
                        ...
                        <p>We got a cab from the airport which would take us to the outskirts of the Medina where we were staying - there were no cars allowed inside, only motorbikes. As we drove, I saw men. Lots of men, young to old, hanging out in groups in the darkness. I saw smoky pool clubs with lots of men crammed inside. I did see the occasional woman out and about, but they were sensible and travelled in groups. Before flying, I'd made a mistake in reading some of the horror stories travellers had encountered in Morocco, from sexual harassment, to pickpocketing, and all manner of scams. It didn't do my sense of ease any good, but it did give me advice that turned out to be quite solid.</p>
