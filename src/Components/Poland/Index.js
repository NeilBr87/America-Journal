...
export default function Poland(props) {
            ...
            <div id="expand">
                ...
                {day1 &&
                    ...
                    <div className="days" id="day2">    
                        ...
                        <p>On the way back, we experienced something that gave us a much better sense of the people of Morocco than anyone we'd met thus far. It all started with Steph looking into a random doorway in search of somewhere to get coffee and finding a cafe with several similing faces staring back. We went inside and were introduced to the lovely people of <i>Nghma wa tay</i>, or 'Music and Tea', a brand new cafe and restaurant in town. They were extremely welcoming and friendly, and served us delicious coffee with biscuits - for no charge! We posed with pictures for them and arranged to come back tomorrow night for some delicious tagines. </p>
                    ...
                    <div className="days" id="day3">
                        <p>I think we both relished the extra sleep we got on account of not doing the excursion, but we still woke up relatively early and went for breakfast. We ate the same meal as yesterday before setting off. Our route to the Marinid tombs would take us outside of the Medina, to the very edge of the city. We headed to a gate we'd never used before on the opposite side to where we'd left for the gardens. As soon as we got outside, it was like we were bang on the edge of the city. There was nothing in front of us other than hills, and a large road which evidently wrapped around the city like a belt.</p>
                        <p>We crossed the road and found ourselves climbing a steep flight of stairs which the instructions on my phone said would take us onto a path towards the tombs. The stairs led to a picturesque cemetery in a white stone that despite being cracked and broken still shone brightly against the sun. We followed the path upwards, the heat of the day getting much stronger; it felt like we were walking directly on a path towards the sun. We followed the path all the way up to the top of the hill, and saw the tombs ahead of us.</p>
                        <p>The ruins were small but quite impressive. The main tomb, the only structure within the ruins relatively intact, was a narrow square with a large Romanesque arch for an entranceway. The thing had lots of graffiti on it, which is a big shame. There were also small ground tombs made out of ancient stone building blocks. As we surveyed the scene, there was an old man at the top talking to a couple of tourists. We recognised him straight away - he's the type that just starts talking to you at a sight of historical interest then asks for a tip for the information he's giving you, just like the guy back at the Madrasa. As the other tourists broke off, he turned his attention to us we avoided him with a polite smile.</p>
                        <p>We did end up chatting to the old man purely out of sympathy. A Chinese tourist had climbed up to the hilltop after us, and when the old man had talked to him, he'd completely blanked him. Not in the polite way we'd done it, but in the 'you literally don't exist to me' way. We saw a little drop in the man's face and came up to him, saying something innocuous about how the ruins were very beautiful or something. That was a mistake. When we went to sit down he came straight over to us, talking to us about the dynasties of Morocco and the growth of Islam in the area. It was interesting stuff, and I know enough about the Islamic golden age to blag a conversation, and we were soon talking about Ibn Sina and the great Bagdhad academics. Of course, by the end he asked us for a tip, but we didn't mind, and the ten Dirhams he asked for was only a pound.</p>
                        <p>There was a path along the top of the hill towards the Borj Nord, but while we couldn't see any scaffolding or outward signs that the place was closed, it didn't look open either. We made the decision to take a side path off, back into the Medina so we could head over to the Mellah. We made our way inside, heading over to the Riad for an air conditioning-assisted cooldown. When we got inside, Youssuf hailed us. Apparently, he hadn't charged us enough on the card and wanted to collect the difference, 60 Dirhams or six pounds. It had to do with the credit card interest charges, but we weren't having a single bit of it. We argued with him, telling him we'd ask Booking.com and we wouldn't pay a penny if they told us we didn't have to. He reluctantly agreed and we went inside. Steph contacted Booking, and I looked at some of the past reviews for the place. I noticed a few that mentioned Youssuf by name and  mentioned similar attempts at scams. We came out and told him that we weren't going to pay him. His tone had changed; he said we didn't have to pay anything in a sort of sad, dejected way.</p>
                        <p>You learn to recognise this with the local hustlers in Morocco. The leather shop guy did it, the guy that sold me my kaftan briefly did it. They act sad, like you've broken their heart, prompting unsavvy tourists to sympathise and relent. It's clever, but didn't work. We left there, heading out to the outskirts of the medina. The sun was high, and we fancied a break for refreshments. We found a place - only one place, though there was apparently another place we didn't find - that was in a hotel. The bar itself was on an upper terrace and was completely deserted apart from us and a barmaid. The beer was Casablanca (that's the brand; I haven't gone mad and started seeing whole cities or movies in bottles) and it was very decent. We had a few, then took a taxi over to the Mellah. </p>
                        <p>The Jewish cemetery was very much like the one we'd seen earlier, pristine white. It was a lot more decorative, though, with large mausoleums with ornate patterns on. It was expansive, with a nice, peaceful walk routed through it. Sol Hachuel, a Jewish martyr in the 1830s killed for refusing to convert to Islam, was buried there, and we learned about her. She was the only person we could read about, though, as most of the graves were understandably in Hebrew. We walked around then headed down the road towards another souk. It was tatty so we got in an Uber over to another spot we'd wanted to check out - the Carrefour. While Carrefour as a supermarket isn't in the same league as Auchan, it's still pretty great, and we thought it would be a good place to get some snacks for the next few days. We did, after all, have two solid days of travelling. Tomomorrow we had an almost eight hour round trip to Chefchaouen, then the day after we had a seven hour train ride to Marrakech.</p> 
                        <p>The place made us think, just briefly, that we'd stepped out of our exotic Moroccan holiday and into a French weekend break. The place was indistinguishable from its nort hern counterparts, which thankfully included the aircon to match. We got some snacks, both sweet and savoury, and sat down for a very late lunch.</p>
                        <p>We had a reservation for Nhgma wa tay at six, but we still had some time, so we decided on a leisurely walk back. It was a mistake. The sun was still exceptionally strong, and after only around ten minutes, we were feeling it. I wished I'd opted to wear my kaftan or that we'd gone for a place where shorts were more socially acceptable. All the same, we got there in good time, and settled in to those same smiling faces. The snack we'd had at Carrefour had more tickled out appetite than sated it, and we were ready for some lovely tagine. I opted for the lemon chicken (that's chicken marinated with the rinds and juices of Mediterranian lemons, get all thoughts of South London Chinese takeaway out of your heathen head) whereas Steph opted for the veggie option naturally. The flavours were amazing, rich but not overpowering, and the food had lots of accompaniments in the forms of breads and local favourites. When we finally got the bill, it was the Dirham equivalent of <i>£17 in total</i>, an amazing deal you'd never see for two hefty dinners in Fes or elsewhere. We made a great show of insisting on paying more, then settled on a large tip. We wished them the very best of luck with their grand opening in two days time, and on checking Instagram to see how they are doing about now, they never needed it!</p>
                        <p>Nghma wa tay was a great reminder on the true nature and culture of Moroccan and North African people. They are way more inclined to be kind and hospitable than many people you come across, and if your experience in Morocco was different to that, then think about how infinitely poorer the peopkle are than you and what you'd do to feed your kids if you lived in a poor country.</p>
                        <p>We had very full bellies and tired heads after our tagines, so we headed back to the room, showered and relaxed. Our alarms were set for crazy-o-clock tomorrow; our coach to Chefchaouen was leaving at seven, but we couldn't simply get an uber to the pickup location as it was on the other side of the medina and of course, cars aren't allowed in the medina.</p>
                    </div>}
